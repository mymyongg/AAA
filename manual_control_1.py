...
class KeyboardControl(object):
    ...
    def __init__(self, world, start_in_autopilot, constant_throttle, use_g27):
    ...
    def _parse_vehicle_keys(self, keys, milliseconds):
        ...
        if self.use_g27:
            ...
            if self.constant_throttle != 0.0:
                self._control.throttle = self.constant_throttle
        #######################################################################################
...
def game_loop(args):
    ...
    try:
        ...
        controller = KeyboardControl(world, args.autopilot, args.throttle, args.g27)
...
def main():
    ...
    argparser.add_argument(
        ...
        default=0.0,
        type=float,
        help='Constant throttle value (default: 0.0)')
    argparser.add_argument(
        '--g27',
        default=False,
        type=bool,
