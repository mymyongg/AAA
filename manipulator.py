...
class KeyboardControl(object):
    ...
    def __init__(self, world, start_in_autopilot, cruise_control, use_g27):
        ...
        self.world = world
        self.pid_controller = PID(1.0, 0.1, 0.05, setpoint=self.cruise_control, output_limits=(0.0, 1.0), sample_time=0.05)

        if self.use_g27:
            pygame.joystick.init()
            if pygame.joystick.get_count() != 0:
                self.g27 = pygame.joystick.Joystick(0)
                self.g27.init()
                print('{} detected.'.format(self.g27.get_name()))
    ...
    def _parse_vehicle_keys(self, keys, milliseconds):
        ...
        if self.use_g27:
            ...
            if self.cruise_control != 0.0:
                ...
                self._control.throttle = self.pid_controller(speed)
        #######################################################################################
...
def game_loop(args):
    ...
    try:
        ...
        controller = KeyboardControl(world, args.autopilot, args.cruise, args.g27)
...
def main():
    ...
    argparser.add_argument(
        ...
        default=0.0,
        type=float,
        help='Cruise control speed value (default: 0.0)')
    argparser.add_argument(
        '--g27',
        default=False,
        type=bool,
        help='Use Logitech G27 (default: False)')
