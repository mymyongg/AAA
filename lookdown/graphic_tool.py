...
class GraphicTool():
    ...
    def update_plot(self, true_y, est_y, true_psi, est_psi, unc_y, unc_psi, rho_v):
        ...
        pygame.draw.rect(self.screen, (0, 255, 0), [310, 190, unc_y / 3.0 * 80, 20])
        
        pygame.draw.rect(self.screen, (255, 0, 0), [310, 220, 80, 20])
        pygame.draw.rect(self.screen, (0, 255, 0), [310, 220, unc_psi / 0.3 * 80, 20])

        # pygame.draw.rect(self.screen, (255, 0, 0), [310, 250, 80, 20])
        # pygame.draw.rect(self.screen, (0, 255, 0), [310, 250, unc_R / 0.1 * 80, 20])

        # rho_v
        pygame.draw.rect(self.screen, (255, 0, 0), [310, 310, 80, 20])
        pygame.draw.rect(self.screen, (0, 255, 0), [310, 310, rho_v / 1.0 * 80, 20])
